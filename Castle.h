...
public:
	...
	void Act_Castle_Fighters(Priority_queue<Fighter*>& Q_fighters, int N, Queue<Enemy*>& L_Killed, Stack<Healer*>& S_Healers, Queue<Freezer*>& Q_freezers, int TimeStep, bool THROWICE);//omar
	~Castle();
	//
